...
export const copperBars1 = {
  ingredients: [
    [
      { id: "copperOre", amount: 6 },
      { id: "scales", amount: 6 },
    ],
    [
      { id: "wood", amount: 5 },
  ...
  product: { id: "copperBars", amount: 2 },
  stars: 1,
};
export const copperBars2 = {
  ingredients: [
    [
      { id: "copperOre", amount: 5 },
      { id: "scales", amount: 5 },
    ],
    [
      { id: "wood", amount: 5 },
...
export const eggs1 = {
  ...
  product: { id: "eggs", amount: 5 },
  stars: 1,
};
export const fabric0 = {
  ingredients: [
    [
      { id: "plantFiber", amount: 6 },
      { id: "reed", amount: 6 },
      { id: "algae", amount: 6 },
    ],
  ],
  product: { id: "fabric", amount: 2 },
  stars: 0,
};
export const fabric2 = {
  ingredients: [
    [
      { id: "plantFiber", amount: 3 },
      { id: "reed", amount: 3 },
      { id: "algae", amount: 3 },
    ],
  ],
...
export const herbs2 = {
  ...
  product: { id: "herbs", amount: 4 },
  stars: 2,
};
export const incense1 = {
  product: { id: "incense", amount: 10 },
  ingredients: [
    [
      { id: "herbs", amount: 6 },
      { id: "roots", amount: 6 },
    ...
    [
      ...
      { id: "oil", amount: 3 },
      { id: "coal", amount: 2 },
      { id: "seaMarrow", amount: 2 },
    ],
  ],
  stars: 1,
};
export const incense2 = {
  product: { id: "incense", amount: 10 },
  ingredients: [
    [
      { id: "herbs", amount: 5 },
...
export const leather1 = {
  ingredients: [
    [
      ...
      { id: "grain", amount: 2 },
      { id: "algae", amount: 2 },
      { id: "vegetables", amount: 1 },
    ],
  ],
  product: { id: "leather", amount: 4 },
  stars: 1,
};
export const meat1 = {
  ingredients: [
    [
      { id: "plantFiber", amount: 8 },
      { id: "reed", amount: 8 },
      { id: "grain", amount: 8 },
      { id: "algae", amount: 8 },
...
export const packOfBuildingMaterials0 = {
  ingredients: [
    [
      { id: "planks", amount: 10 },
      { id: "fabric", amount: 6 },
      { id: "bricks", amount: 6 },
      { id: "copperOre", amount: 14 },
    ],
  ],
  product: { id: "packOfBuildingMaterials", amount: 2 },
  stars: 0,
};
export const packOfBuildingMaterials1 = {
  ingredients: [
    [
      { id: "planks", amount: 8 },
      { id: "fabric", amount: 5 },
...
export const packOfBuildingMaterials2 = {
  ingredients: [
    [
      { id: "planks", amount: 7 },
      { id: "fabric", amount: 4 },
      { id: "bricks", amount: 4 },
      { id: "copperOre", amount: 10 },
    ],
  ],
  product: { id: "packOfBuildingMaterials", amount: 2 },
  stars: 2,
...
export const packOfCrops0 = {
  ingredients: [
    [
      { id: "roots", amount: 6 },
      { id: "grain", amount: 6 },
      { id: "vegetables", amount: 6 },
      { id: "mushrooms", amount: 6 },
    ],
  ],
  product: { id: "packOfCrops", amount: 2 },
  stars: 0,
};
export const packOfCrops1 = {
  ingredients: [
    [
      { id: "roots", amount: 5 },
      { id: "grain", amount: 5 },
...
export const packOfLuxuryGoods2 = {
  ingredients: [
    [
      { id: "wine", amount: 4 },
      { id: "trainingGear", amount: 4 },
      { id: "incense", amount: 4 },
      { id: "scrolls", amount: 4 },
      { id: "ale", amount: 4 },
      { id: "tea", amount: 4 },
...
export const packOfLuxuryGoods3 = {
  ingredients: [
    [
      { id: "wine", amount: 3 },
      { id: "trainingGear", amount: 3 },
      { id: "incense", amount: 3 },
      { id: "scrolls", amount: 3 },
      { id: "ale", amount: 3 },
      { id: "tea", amount: 3 },
...
export const packOfProvisions0 = {
  ingredients: [
    [
      { id: "roots", amount: 6 },
      { id: "berries", amount: 6 },
  ...
  product: { id: "packOfProvisions", amount: 3 },
  stars: 0,
};
export const packOfProvisions1 = {
  ingredients: [
    [
      { id: "roots", amount: 5 },
      { id: "berries", amount: 5 },
...
export const packOfProvisions2 = {
  ingredients: [
    [
      { id: "roots", amount: 4 },
      { id: "berries", amount: 4 },
...
export const packOfProvisions3 = {
  ingredients: [
    [
      { id: "roots", amount: 3 },
      { id: "berries", amount: 3 },
...
export const packOfTradeGoods1 = {
  ingredients: [
    [
      { id: "dye", amount: 8 },
      { id: "oil", amount: 8 },
...
export const pickledGoods0 = {
  ingredients: [
    [
      { id: "vegetables", amount: 7 },
      { id: "mushrooms", amount: 7 },
      { id: "roots", amount: 7 },
      { id: "berries", amount: 7 },
      { id: "eggs", amount: 7 },
    ],
...
export const planks0 = {
  ingredients: [[{ id: "wood", amount: 8 }]],
  product: { id: "planks", amount: 2 },
  stars: 0,
};
export const planks2 = {
  ingredients: [[{ id: "wood", amount: 5 }]],
  product: { id: "planks", amount: 2 },
  stars: 2,
};
export const planks3 = {
...
export const pottery1 = {
  ...
  product: { id: "pottery", amount: 5 },
  stars: 1,
};
export const pottery2 = {
  ingredients: [
    [{ id: "clay", amount: 3 }],
    [
      { id: "wood", amount: 5 },
...
export const resin2 = {
  ...
  product: { id: "resin", amount: 4 },
  stars: 2,
};
export const scrolls1 = {
  ingredients: [
    [
      { id: "leather", amount: 4 },
      { id: "plantFiber", amount: 4 },
      { id: "wood", amount: 10 },
    ],
    [
      { id: "dye", amount: 3 },
  ...
  product: { id: "scrolls", amount: 8 },
  stars: 1,
};
export const scrolls2 = {
  ingredients: [
    [
      { id: "leather", amount: 3 },
      { id: "plantFiber", amount: 3 },
...
export const trainingGear1 = {
  ...
  product: { id: "trainingGear", amount: 10 },
  stars: 1,
};
export const trainingGear2 = {
  ingredients: [
    [
      { id: "stone", amount: 5 },
      { id: "copperBars", amount: 2 },
